...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KeenIOMetricsQuery'
        db.create_table(u'dashboard_keeniometricsquery', (
            (u'query_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dashboard.Query'], unique=True, primary_key=True)),
            ('metric_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('event_collection', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('target_property', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('filters', self.gf('jsonfield.fields.JSONField')(default=[])),
            ('use_timeframe', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('interval', self.gf('django.db.models.fields.CharField')(default='', max_length=16)),
            ('group_by', self.gf('jsonfield.fields.JSONField')(default=[])),
        ))
    ...
    models = {
        ...
        u'dashboard.keeniometricsquery': {
            ...
            'group_by': ('jsonfield.fields.JSONField', [], {'default': '[]'}),
            'interval': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '16'}),
