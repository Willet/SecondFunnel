...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YoutubeVideo.name'
        db.add_column('assets_youtubevideo', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'YoutubeVideo.description'
        db.add_column('assets_youtubevideo', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YoutubeVideo.slug'
        db.add_column('assets_youtubevideo', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'YoutubeVideo.name'
        db.delete_column('assets_youtubevideo', 'name')

        # Deleting field 'YoutubeVideo.description'
        db.delete_column('assets_youtubevideo', 'description')

        # Deleting field 'YoutubeVideo.slug'
        db.delete_column('assets_youtubevideo', 'slug')
