...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tile.prioritized'
        db.delete_column(u'assets_tile', 'prioritized')


        # Changing field 'Feed.source_urls'
        db.alter_column(u'assets_feed', 'source_urls', self.gf('apps.utils.fields.ListField')())

    def backwards(self, orm):
        # Adding field 'Tile.prioritized'
        db.add_column(u'assets_tile', 'prioritized',
