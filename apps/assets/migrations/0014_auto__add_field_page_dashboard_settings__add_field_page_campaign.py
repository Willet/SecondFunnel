...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.campaign'
        db.add_column(u'assets_page', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Campaign'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.dashboard_settings'
        db.delete_column(u'assets_page', 'dashboard_settings')

        # Deleting field 'Page.campaign'
        db.delete_column(u'assets_page', 'campaign_id')
