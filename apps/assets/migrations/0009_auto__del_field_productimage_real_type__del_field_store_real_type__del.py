...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductImage.real_type'
        db.delete_column(u'assets_productimage', 'real_type_id')

        # Deleting field 'Store.real_type'
        db.delete_column(u'assets_store', 'real_type_id')

        # Deleting field 'Page.real_type'
        db.delete_column(u'assets_page', 'real_type_id')

        # Deleting field 'Product.real_type'
        db.delete_column(u'assets_product', 'real_type_id')

        # Adding field 'Video.original_id'
        db.add_column(u'assets_video', 'original_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Tile.real_type'
        db.delete_column(u'assets_tile', 'real_type_id')

        # Adding field 'Tile.attributes'
        """  # column already exists (why did south generate this then???)
        db.add_column(u'assets_tile', 'attributes',
                      self.gf('jsonfield.fields.JSONField')(default={}, null=True),
                      keep_default=False)
        """

        # Deleting field 'Content.real_type'
        db.delete_column(u'assets_content', 'real_type_id')

        # Deleting field 'Feed.real_type'
        db.delete_column(u'assets_feed', 'real_type_id')

        # Deleting field 'Theme.real_type'
        db.delete_column(u'assets_theme', 'real_type_id')


    def backwards(self, orm):
        # Adding field 'ProductImage.real_type'
        db.add_column(u'assets_productimage', 'real_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Adding field 'Store.real_type'
        db.add_column(u'assets_store', 'real_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Adding field 'Page.real_type'
        db.add_column(u'assets_page', 'real_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Adding field 'Product.real_type'
        db.add_column(u'assets_product', 'real_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Deleting field 'Video.original_id'
        db.delete_column(u'assets_video', 'original_id')

        # Adding field 'Tile.real_type'
        db.add_column(u'assets_tile', 'real_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Deleting field 'Tile.attributes'
        db.delete_column(u'assets_tile', 'attributes')

        # Adding field 'Content.real_type'
        db.add_column(u'assets_content', 'real_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Adding field 'Feed.real_type'
        db.add_column(u'assets_feed', 'real_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Adding field 'Theme.real_type'
        db.add_column(u'assets_theme', 'real_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)
