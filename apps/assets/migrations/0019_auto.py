...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field categories on 'YoutubeVideo'
        db.create_table('assets_youtubevideo_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('youtubevideo', models.ForeignKey(orm['assets.youtubevideo'], null=False)),
            ('intentrankcampaign', models.ForeignKey(orm['pinpoint.intentrankcampaign'], null=False))
        ))
        db.create_unique('assets_youtubevideo_categories', ['youtubevideo_id', 'intentrankcampaign_id'])


    def backwards(self, orm):
        # Removing M2M table for field categories on 'YoutubeVideo'
        db.delete_table('assets_youtubevideo_categories')
    ...
    models = {
        'assets.externalcontent': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'external_content'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['pinpoint.IntentRankCampaign']"}),
        ...
        'assets.youtubevideo': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'videos'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['pinpoint.IntentRankCampaign']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
