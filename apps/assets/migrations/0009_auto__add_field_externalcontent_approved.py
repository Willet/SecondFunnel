...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalContent.approved'
        db.add_column('assets_externalcontent', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExternalContent.approved'
        db.delete_column('assets_externalcontent', 'approved')
