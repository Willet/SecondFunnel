...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'assets_image', 'url')

        # Deleting field 'Video.url'
        db.delete_column(u'assets_video', 'url')

        # Adding field 'Content.url'
        db.add_column(u'assets_content', 'url',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'assets_image', 'url',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Video.url'
        db.add_column(u'assets_video', 'url',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'Content.url'
        db.delete_column(u'assets_content', 'url')
