...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'assets_category', 'url', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Category.url'
        db.alter_column(u'assets_category', 'url', self.gf('django.db.models.fields.TextField')(default=' '))
