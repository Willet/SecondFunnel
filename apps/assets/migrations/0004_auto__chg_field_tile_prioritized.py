...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tile.prioritized'
        db.alter_column(u'assets_tile', 'prioritized', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Tile.prioritized'
        db.alter_column(u'assets_tile', 'prioritized', self.gf('django.db.models.fields.BooleanField')(default=''))
