...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductMedia.last_modified'
        db.delete_column('assets_productmedia', 'last_modified')

        # Adding it back in with a permanent default value (keep_default flag)
        db.add_column('assets_productmedia', 'last_modified',
    ...
    def backwards(self, orm):
        ...
        # Adding it back in without a permanent default value (keep_default flag)
        db.add_column('assets_productmedia', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, auto_now=True, null=True, blank=True),
                      keep_default=False)
