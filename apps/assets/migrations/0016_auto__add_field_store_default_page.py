...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.default_page'
        db.add_column(u'assets_store', 'default_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='default_store', null=True, on_delete=models.SET_NULL, to=orm['assets.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.default_page'
        db.delete_column(u'assets_store', 'default_page_id')
