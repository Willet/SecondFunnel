...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.dominant_colour'
        db.add_column(u'assets_productimage', 'dominant_colour',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductImage.attributes'
        db.add_column(u'assets_productimage', 'attributes',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'ProductImage.file_type'
        db.alter_column(u'assets_productimage', 'file_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ProductImage.file_checksum'
        db.alter_column(u'assets_productimage', 'file_checksum', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
        # Adding field 'Image.dominant_colour'
        db.add_column(u'assets_image', 'dominant_colour',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Image.file_checksum'
        db.alter_column(u'assets_image', 'file_checksum', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Image.file_type'
        db.alter_column(u'assets_image', 'file_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Video.file_type'
        db.alter_column(u'assets_video', 'file_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Video.file_checksum'
        db.alter_column(u'assets_video', 'file_checksum', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Feed.feed_algorithm'
        db.alter_column(u'assets_feed', 'feed_algorithm', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Theme.name'
        db.alter_column(u'assets_theme', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):
        # Deleting field 'ProductImage.dominant_colour'
        db.delete_column(u'assets_productimage', 'dominant_colour')

        # Deleting field 'ProductImage.attributes'
        db.delete_column(u'assets_productimage', 'attributes')


        # Changing field 'ProductImage.file_type'
        db.alter_column(u'assets_productimage', 'file_type', self.gf('django.db.models.fields.CharField')(default='jpg', max_length=255))

        # Changing field 'ProductImage.file_checksum'
        db.alter_column(u'assets_productimage', 'file_checksum', self.gf('django.db.models.fields.CharField')(default='', max_length=512))
        # Deleting field 'Image.dominant_colour'
        db.delete_column(u'assets_image', 'dominant_colour')


        # Changing field 'Image.file_checksum'
        db.alter_column(u'assets_image', 'file_checksum', self.gf('django.db.models.fields.CharField')(default='', max_length=512))

        # Changing field 'Image.file_type'
        db.alter_column(u'assets_image', 'file_type', self.gf('django.db.models.fields.CharField')(default='jpg', max_length=255))

        # Changing field 'Video.file_type'
        db.alter_column(u'assets_video', 'file_type', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Video.file_checksum'
        db.alter_column(u'assets_video', 'file_checksum', self.gf('django.db.models.fields.CharField')(default='', max_length=512))

        # Changing field 'Feed.feed_algorithm'
        db.alter_column(u'assets_feed', 'feed_algorithm', self.gf('django.db.models.fields.CharField')(default='random', max_length=64))

        # Changing field 'Theme.name'
        db.alter_column(u'assets_theme', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=1024))
    ...
    models = {
        ...
        u'assets.image': {
            ...
            'dominant_colour': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
