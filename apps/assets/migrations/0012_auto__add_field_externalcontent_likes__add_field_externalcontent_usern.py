...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalContent.likes'
        db.add_column('assets_externalcontent', 'likes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ExternalContent.username'
        db.add_column('assets_externalcontent', 'username',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExternalContent.user_image'
        db.add_column('assets_externalcontent', 'user_image',
                      self.gf('django.db.models.fields.CharField')(max_length=555, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExternalContent.likes'
        db.delete_column('assets_externalcontent', 'likes')

        # Deleting field 'ExternalContent.username'
        db.delete_column('assets_externalcontent', 'username')

        # Deleting field 'ExternalContent.user_image'
        db.delete_column('assets_externalcontent', 'user_image')
