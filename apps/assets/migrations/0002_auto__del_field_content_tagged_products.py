...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Content.tagged_products'
        db.delete_column(u'assets_content', 'tagged_products')
    ...
    def backwards(self, orm):
        # Adding field 'Content.tagged_products'
        db.add_column(u'assets_content', 'tagged_products',
