...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalContentType'
        db.create_table('assets_externalcontenttype', (
        ...
        db.send_create_signal('assets', ['ExternalContentType'])

        # Adding model 'ExternalContent'
        db.create_table('assets_externalcontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('original_id', self.gf('django.db.models.fields.CharField')(max_length=555, null=True, blank=True)),
            ('original_url', self.gf('django.db.models.fields.CharField')(max_length=555, null=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.ExternalContentType'])),
            ('text_content', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('image_url', self.gf('django.db.models.fields.CharField')(max_length=555, null=True, blank=True)),
        ))
        db.send_create_signal('assets', ['ExternalContent'])

        # Adding M2M table for field tagged_products on 'ExternalContent'
        db.create_table('assets_externalcontent_tagged_products', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('externalcontent', models.ForeignKey(orm['assets.externalcontent'], null=False)),
            ('product', models.ForeignKey(orm['assets.product'], null=False))
        ))
        db.create_unique('assets_externalcontent_tagged_products', ['externalcontent_id', 'product_id'])


    def backwards(self, orm):
        # Deleting model 'ExternalContentType'
        db.delete_table('assets_externalcontenttype')

        # Deleting model 'ExternalContent'
        db.delete_table('assets_externalcontent')

        # Removing M2M table for field tagged_products on 'ExternalContent'
        db.delete_table('assets_externalcontent_tagged_products')
    ...
    models = {
        'assets.externalcontent': {
            ...
            'tagged_products': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['assets.Product']", 'null': 'True', 'blank': 'True'}),
        ...
        'assets.product': {
            ...
            'lifestyleImage': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'associated_product'", 'null': 'True', 'to': "orm['assets.GenericImage']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
