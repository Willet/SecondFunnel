...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.last_scraped'
        db.add_column('assets_product', 'last_scraped',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.last_scraped'
        db.delete_column('assets_product', 'last_scraped')
