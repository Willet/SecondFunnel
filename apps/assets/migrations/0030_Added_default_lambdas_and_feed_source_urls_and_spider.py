...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.spider_name'
        db.add_column(u'assets_feed', 'spider_name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'assets_feed', 'spider_name')

        # Changing field 'Feed.source_urls'
        db.delete_column(u'assets_feed', 'source_urls')
        db.add_column(u'assets_feed', 'source_urls', self.gf('django.db.models.fields.TextField')(null=True))
