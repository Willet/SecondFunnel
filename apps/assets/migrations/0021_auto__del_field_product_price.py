...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'assets_product', 'price')
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Product.price'
        db.add_column(u'assets_product', 'price',
