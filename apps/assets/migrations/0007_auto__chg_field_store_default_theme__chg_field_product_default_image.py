...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Store.default_theme'
        db.alter_column(u'assets_store', 'default_theme_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['assets.Theme']))

        # Changing field 'Product.default_image'
        db.alter_column(u'assets_product', 'default_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['assets.ProductImage']))

    def backwards(self, orm):

        # Changing field 'Store.default_theme'
        db.alter_column(u'assets_store', 'default_theme_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['assets.Theme']))

        # Changing field 'Product.default_image'
        db.alter_column(u'assets_product', 'default_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['assets.ProductImage']))
