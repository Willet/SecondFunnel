...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field social_auth on 'Store'
        db.create_table('assets_store_social_auth', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('store', models.ForeignKey(orm['assets.store'], null=False)),
            ('usersocialauth', models.ForeignKey(orm['social_auth.usersocialauth'], null=False))
        ))
        db.create_unique('assets_store_social_auth', ['store_id', 'usersocialauth_id'])


    def backwards(self, orm):
        # Removing M2M table for field social_auth on 'Store'
        db.delete_table('assets_store_social_auth')
