...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field categories on 'ExternalContent'
        db.create_table('assets_externalcontent_categories', (
        ...
        db.create_unique('assets_externalcontent_categories', ['externalcontent_id', 'intentrankcampaign_id'])


    def backwards(self, orm):
        # Removing M2M table for field categories on 'ExternalContent'
        db.delete_table('assets_externalcontent_categories')
