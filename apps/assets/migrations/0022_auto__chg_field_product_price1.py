...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.price1'
        db.alter_column(u'assets_product', 'price1', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Product.price1'
        db.alter_column(u'assets_product', 'price1', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        u'assets.product': {
            ...
            'price1': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
