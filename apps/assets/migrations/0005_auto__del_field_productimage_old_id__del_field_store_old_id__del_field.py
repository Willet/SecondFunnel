...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductImage.old_id'
        db.delete_column(u'assets_productimage', 'old_id')

        # Deleting field 'Store.old_id'
        db.delete_column(u'assets_store', 'old_id')

        # Deleting field 'Page.old_id'
        db.delete_column(u'assets_page', 'old_id')

        # Deleting field 'Product.old_id'
        db.delete_column(u'assets_product', 'old_id')

        # Deleting field 'Content.old_id'
        db.delete_column(u'assets_content', 'old_id')

        # Deleting field 'Tile.old_id'
        db.delete_column(u'assets_tile', 'old_id')


    def backwards(self, orm):
        # Adding field 'ProductImage.old_id'
        db.add_column(u'assets_productimage', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None, unique=True),
                      keep_default=False)

        # Adding field 'Store.old_id'
        db.add_column(u'assets_store', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None, unique=True),
                      keep_default=False)

        # Adding field 'Page.old_id'
        db.add_column(u'assets_page', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None, unique=True),
                      keep_default=False)

        # Adding field 'Product.old_id'
        db.add_column(u'assets_product', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None, unique=True),
                      keep_default=False)

        # Adding field 'Content.old_id'
        db.add_column(u'assets_content', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None, unique=True),
                      keep_default=False)

        # Adding field 'Tile.old_id'
        db.add_column(u'assets_tile', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None, unique=True, db_index=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'assets.tile': {
            ...
            'content': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['assets.Content']", 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['assets.Product']", 'null': 'True', 'blank': 'True'}),
