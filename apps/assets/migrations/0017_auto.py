...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field similar_products on 'Product'
        m2m_table_name = db.shorten_name(u'assets_product_similar_products')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_product', models.ForeignKey(orm[u'assets.product'], null=False)),
            ('to_product', models.ForeignKey(orm[u'assets.product'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_product_id', 'to_product_id'])


    def backwards(self, orm):
        # Removing M2M table for field similar_products on 'Product'
        db.delete_table(db.shorten_name(u'assets_product_similar_products'))
