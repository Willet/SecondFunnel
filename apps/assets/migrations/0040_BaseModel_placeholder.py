...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.placeholder'
        db.add_column(u'assets_productimage', 'placeholder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Category.placeholder'
        db.add_column(u'assets_category', 'placeholder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Store.placeholder'
        db.add_column(u'assets_store', 'placeholder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Page.placeholder'
        db.add_column(u'assets_page', 'placeholder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.placeholder'
        db.add_column(u'assets_product', 'placeholder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Tag.placeholder'
        db.add_column(u'assets_tag', 'placeholder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Content.placeholder'
        db.add_column(u'assets_content', 'placeholder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Feed.placeholder'
        db.add_column(u'assets_feed', 'placeholder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Theme.placeholder'
        db.add_column(u'assets_theme', 'placeholder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductImage.placeholder'
        db.delete_column(u'assets_productimage', 'placeholder')

        # Deleting field 'Category.placeholder'
        db.delete_column(u'assets_category', 'placeholder')

        # Deleting field 'Store.placeholder'
        db.delete_column(u'assets_store', 'placeholder')

        # Deleting field 'Page.placeholder'
        db.delete_column(u'assets_page', 'placeholder')

        # Deleting field 'Product.placeholder'
        db.delete_column(u'assets_product', 'placeholder')

        # Deleting field 'Tag.placeholder'
        db.delete_column(u'assets_tag', 'placeholder')

        # Deleting field 'Content.placeholder'
        db.delete_column(u'assets_content', 'placeholder')

        # Deleting field 'Feed.placeholder'
        db.delete_column(u'assets_feed', 'placeholder')

        # Deleting field 'Theme.placeholder'
        db.delete_column(u'assets_theme', 'placeholder')
