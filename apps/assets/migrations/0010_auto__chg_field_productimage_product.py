...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductImage.product'
        db.alter_column(u'assets_productimage', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['assets.Product']))

    def backwards(self, orm):

        # Changing field 'ProductImage.product'
        db.alter_column(u'assets_productimage', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['assets.Product']))
