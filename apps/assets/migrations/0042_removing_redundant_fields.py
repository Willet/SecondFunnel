...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'assets_image', 'description')

        # Deleting field 'Image.name'
        db.delete_column(u'assets_image', 'name')

        # Deleting field 'Image.original_url'
        db.delete_column(u'assets_image', 'original_url')
        ...
        db.delete_column(u'assets_video', 'description')

        # Deleting field 'Video.name'
        db.delete_column(u'assets_video', 'name')

        # Deleting field 'Content.author'
        db.delete_column(u'assets_content', 'author')

        # Adding field 'Content.name'
        db.add_column(u'assets_content', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Content.description'
        db.add_column(u'assets_content', 'description',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'assets_image', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.name'
        db.add_column(u'assets_image', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.original_url'
        db.add_column(u'assets_image', 'original_url',
        ...
        db.add_column(u'assets_video', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.name'
        db.add_column(u'assets_video', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Content.author'
        db.add_column(u'assets_content', 'author',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Content.name'
        db.delete_column(u'assets_content', 'name')

        # Deleting field 'Content.description'
        db.delete_column(u'assets_content', 'description')
