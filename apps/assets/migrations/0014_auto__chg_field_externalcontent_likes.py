...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExternalContent.likes'
        db.alter_column('assets_externalcontent', 'likes', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExternalContent.likes'
        db.alter_column('assets_externalcontent', 'likes', self.gf('django.db.models.fields.IntegerField')())
