...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('assets', ['Store'])

        # Adding M2M table for field staff on 'Store'
        db.create_table('assets_store_staff', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('store', models.ForeignKey(orm['assets.store'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('assets_store_staff', ['store_id', 'user_id'])

        # Adding model 'GenericMedia'
        db.create_table('assets_genericmedia', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal('assets', ['GenericMedia'])

        # Adding model 'GenericImage'
        db.create_table('assets_genericimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True)),
            ('remote', self.gf('django.db.models.fields.CharField')(max_length=555, null=True, blank=True)),
            ('hosted', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('assets', ['GenericImage'])

        # Adding model 'Product'
        db.create_table('assets_product', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True)),
            ('original_url', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Store'], null=True, blank=True)),
            ...
            ('rescrape', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('lifestyleImage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.GenericImage'], null=True, blank=True)),
            ('available', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('assets', ['Product'])

        # Adding model 'ProductMedia'
        db.create_table('assets_productmedia', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('remote', self.gf('django.db.models.fields.CharField')(max_length=555, null=True, blank=True)),
            ('hosted', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='media', to=orm['assets.Product'])),
        ))
        db.send_create_signal('assets', ['ProductMedia'])

        # Adding model 'YoutubeVideo'
        db.create_table('assets_youtubevideo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('video_id', self.gf('django.db.models.fields.CharField')(max_length=11)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(related_name='videos', null=True, to=orm['assets.Store'])),
        ))
        db.send_create_signal('assets', ['YoutubeVideo'])


    def backwards(self, orm):
        # Deleting model 'Store'
        db.delete_table('assets_store')

        # Removing M2M table for field staff on 'Store'
        db.delete_table('assets_store_staff')

        # Deleting model 'GenericMedia'
        db.delete_table('assets_genericmedia')

        # Deleting model 'GenericImage'
        db.delete_table('assets_genericimage')

        # Deleting model 'Product'
        db.delete_table('assets_product')

        # Deleting model 'ProductMedia'
        db.delete_table('assets_productmedia')

        # Deleting model 'YoutubeVideo'
        db.delete_table('assets_youtubevideo')
