...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assets_product', 'store',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Store'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('assets_product', 'store_id')
    ...
    models = {
        ...
        'assets.product': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'images': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['assets.Media']", 'null': 'True', 'blank': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
