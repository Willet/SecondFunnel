...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalContent.active'
        db.add_column('assets_externalcontent', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExternalContent.active'
        db.delete_column('assets_externalcontent', 'active')
