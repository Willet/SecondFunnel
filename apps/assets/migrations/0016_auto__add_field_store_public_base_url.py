...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.public_base_url'
        db.add_column('assets_store', 'public_base_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.public_base_url'
        db.delete_column('assets_store', 'public_base_url')
