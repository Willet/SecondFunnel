...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.lifestyleImage'
        db.delete_column('assets_product', 'lifestyleImage_id')

        # Adding M2M table for field lifestyleImages on 'Product'
        db.create_table('assets_product_lifestyleImages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm['assets.product'], null=False)),
            ('genericimage', models.ForeignKey(orm['assets.genericimage'], null=False))
        ))
        db.create_unique('assets_product_lifestyleImages', ['product_id', 'genericimage_id'])


    def backwards(self, orm):
        # Adding field 'Product.lifestyleImage'
        db.add_column('assets_product', 'lifestyleImage',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='associated_product', null=True, to=orm['assets.GenericImage'], blank=True),
                      keep_default=False)

        # Removing M2M table for field lifestyleImages on 'Product'
        db.delete_table('assets_product_lifestyleImages')
