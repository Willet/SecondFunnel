...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.price1'
        db.add_column(u'assets_product', 'price1',
        ...
        db.add_column(u'assets_product', 'sale_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.price1'
        db.delete_column(u'assets_product', 'price1')

        # Deleting field 'Product.sale_price'
        db.delete_column(u'assets_product', 'sale_price')
    ...
    models = {
        ...
        u'assets.product': {
            ...
            'price1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
