...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.feed_ratio'
        db.add_column(u'assets_feed', 'feed_ratio',
                      self.gf('django.db.models.fields.DecimalField')(default=0.2, max_digits=2, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.feed_ratio'
        db.delete_column(u'assets_feed', 'feed_ratio')
