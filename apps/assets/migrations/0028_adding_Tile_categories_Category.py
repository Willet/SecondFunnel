...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'assets_category', (
            ...
            ('ir_cache', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(related_name='categories', to=orm['assets.Store'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('url', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'assets', ['Category'])

        # Adding M2M table for field tiles on 'Category'
        m2m_table_name = db.shorten_name(u'assets_category_tiles')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm[u'assets.category'], null=False)),
            ('tile', models.ForeignKey(orm[u'assets.tile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['category_id', 'tile_id'])

    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table(u'assets_category')

        # Removing M2M table for field tiles on 'Category'
        db.delete_table(db.shorten_name(u'assets_category_tiles'))
