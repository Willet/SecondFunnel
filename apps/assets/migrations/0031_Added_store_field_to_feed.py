...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.store'
        db.add_column(u'assets_feed', 'store',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='feeds', to=orm['assets.Store']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.store'
        db.delete_column(u'assets_feed', 'store_id')
    ...
    models = {
        ...
        u'assets.feed': {
            ...
            'source_urls': ('jsonfield.fields.JSONField', [], {'default': '[]'}),
