...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StoreFeature'
        db.create_table('assets_storefeature', (
        ...
        db.send_create_signal('assets', ['StoreFeature'])

        # Adding M2M table for field features on 'Store'
        db.create_table('assets_store_features', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('store', models.ForeignKey(orm['assets.store'], null=False)),
            ('storefeature', models.ForeignKey(orm['assets.storefeature'], null=False))
        ))
        db.create_unique('assets_store_features', ['store_id', 'storefeature_id'])


    def backwards(self, orm):
        # Deleting model 'StoreFeature'
        db.delete_table('assets_storefeature')

        # Removing M2M table for field features on 'Store'
        db.delete_table('assets_store_features')
