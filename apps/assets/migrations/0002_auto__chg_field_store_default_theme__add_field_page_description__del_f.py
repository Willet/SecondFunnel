...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'assets_page', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Theme.store'
        db.delete_column(u'assets_theme', 'store_id')


    def backwards(self, orm):

        # Changing field 'Store.default_theme'
        db.alter_column(u'assets_store', 'default_theme_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pinpoint.StoreTheme']))
        # Deleting field 'Page.description'
        db.delete_column(u'assets_page', 'description')

        # Adding field 'Theme.store'
        db.add_column(u'assets_theme', 'store',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['assets.Store']),
                      keep_default=False)
