...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductImage.dominant_color'
        db.add_column(u'assets_productimage', 'dominant_color',
        ...
        # Adding field 'Image.dominant_color'
        db.add_column(u'assets_image', 'dominant_color',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProductImage.dominant_color'
        db.delete_column(u'assets_productimage', 'dominant_color')
        ...
        # Deleting field 'Image.dominant_color'
        db.delete_column(u'assets_image', 'dominant_color')
