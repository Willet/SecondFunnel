...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('assets_productprice', (
        ...
        db.send_create_signal('assets', ['ProductPrice'])

        # Deleting field 'Product.price'
        db.delete_column('assets_product', 'price')


    def backwards(self, orm):
        # Deleting model 'ProductPrice'
        db.delete_table('assets_productprice')

        # Adding field 'Product.price'
        db.add_column('assets_product', 'price',
