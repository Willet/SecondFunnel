...
from apps.assets.models import Tile, Page, Product, Content
from apps.api2.serializers import TileSerializer, ProductSerializer, ContentSerializer
...
class APITest(APITestCase):
    ...
    def product_search_URL_successful_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'url': 'http://www.facebook.com/product'})
    ...
    def product_search_sku_successful_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'sku': 355353})
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.data['status'], 'Products with the following ID have been found: 12.')
        self.assertEqual(response.data['ids'], [12])
        self.assertEqual(response.data['products'][0]['sku'], u'355353')
    ...
    def product_search_ID_successful_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'id': 12})
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.data['status'], 'Products with the following ID have been found: 12.')
        self.assertEqual(response.data['ids'], [12])
        self.assertEqual(response.data['products'][0]['sku'], u'355353')
    ...
    def product_search_multiple_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'url': "http://www.yahoo.com/product"})
        self.assertEqual(response.status_code, 200)
    ...
    def product_search_URL_unsuccessful_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'url': 'http://www.secondfunnel.com'})
    ...
    def product_search_sku_unsuccessful_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'sku': 123456789})
        self.assertEqual(response.status_code, 404)
        self.assertEqual(response.data['status'], 'No product was found.')
        self.assertEqual(response.data['ids'], [])
        self.assertEqual(response.data['products'], [])
    ...
    def product_search_ID_unsuccessful_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'id': 12356})
        self.assertEqual(response.status_code, 404)
        self.assertEqual(response.data['status'], 'No product was found.')
        self.assertEqual(response.data['ids'], [])
        self.assertEqual(response.data['products'], [])
    ...
    def product_search_URL_input_numbers_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'url': "12345"})
    ...
    def product_search_URL_input_letters_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'url': "asdf1234asf"})
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data['status'], 'Bad URL input detected.')
        self.assertEqual(response.data['ids'], [])
        self.assertEqual(response.data['products'], [])
    ...
    def product_search_sku_input_URL_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'sku': "http://www.google.com"})
        self.assertEqual(response.status_code, 400)
    ...
    def product_search_sku_input_letters_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'sku': "asdf123456"})
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data['status'], 'Expecting a number as input, but got non-number.')
        self.assertEqual(response.data['ids'], [])
        self.assertEqual(response.data['products'], [])
    ...
    def product_search_ID_input_URL_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'id': "http://www.google.com"})
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data['status'], 'Expecting a number as input, but got non-number.')
        self.assertEqual(response.data['ids'], [])
        self.assertEqual(response.data['products'], [])
    ...
    def product_search_ID_input_letters_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'sku': "asdf1234"})
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data['status'], 'Expecting a number as input, but got non-number.')
        self.assertEqual(response.data['ids'], [])
        self.assertEqual(response.data['products'], [])
    ...
    def product_search_bad_store_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1335, 'sku': "asdf1234"})
        self.assertEqual(response.status_code, 400)
    ...
    def product_search_no_input_test(self):
        response = self.client.get('/api2/product/search/')
        self.assertEqual(response.status_code, 400)
    ...
    def product_search_multiple_input_test(self):
        response = self.client.get('/api2/product/search/', {'store': 1, 'id': 105, 'sku': 1000, 'url': "12345"})
        self.assertEqual(response.status_code, 400)
    ...
    def content_search_URL_successful_test(self):
        response = self.client.get('/api2/content/search/', {'store': 1, 'url': 'http://www.google.com'})
    ...
    def content_search_ID_successful_test(self):
        response = self.client.get('/api2/content/search/', {'store': 14, 'id': 16})
    ...
    def content_search_multiple_test(self):
        response = self.client.get('/api2/content/search/', {'store': 14, 'url': "http://www.facebook.com"})
        self.assertEqual(response.status_code, 200)
    ...
    def content_search_URL_unsuccessful_test(self):
        response = self.client.get('/api2/content/search/', {'store': 1, 'url': 'http://www.secondfunnel.com'})
        self.assertEqual(response.status_code, 404)
    ...
    def content_search_ID_unsuccessful_test(self):
        response = self.client.get('/api2/content/search/', {'store': 1, 'id': 12356})
        self.assertEqual(response.status_code, 404)
    ...
    def content_search_URL_input_numbers_test(self):
        response = self.client.get('/api2/content/search/', {'store': 1, 'url': "12345"})
        self.assertEqual(response.status_code, 400)
    ...
    def content_search_URL_input_letters_test(self):
        response = self.client.get('/api2/content/search/', {'store': 1, 'url': "asdf1234asf"})
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data['status'], u'Bad URL input detected.')
        self.assertEqual(response.data['ids'], [])
        self.assertEqual(response.data['contents'], [])
    ...
    def content_search_ID_input_URL_test(self):
        response = self.client.get('/api2/content/search/', {'store': 1, 'id': "http://www.google.com"})
        self.assertEqual(response.status_code, 400)
    ...
    def content_search_ID_input_letters_test(self):
        response = self.client.get('/api2/content/search/', {'store': 1, 'id': "asdf1234"})
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data['status'], u'Expecting a number as input, but got non-number.')
        self.assertEqual(response.data['ids'], [])
        self.assertEqual(response.data['contents'], [])
    ...
    def content_search_bad_store_test(self):
        response = self.client.get('/api2/content/search/', {'store': 13531, 'id': "1"})
        self.assertEqual(response.status_code, 400)
    ...
    def content_search_no_input_test(self):
        response = self.client.get('/api2/content/search/')
        self.assertEqual(response.status_code, 400)
    ...
    def content_search_multiple_input_test(self):
        response = self.client.get('/api2/content/search/', {'store': 1, 'id': 105, 'name': 1000, 'url': "12345"})
        self.assertEqual(response.status_code, 400)
