...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreScraper.status'
        db.add_column('scraper_storescraper', 'status',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StoreScraper.status'
        db.delete_column('scraper_storescraper', 'status')
