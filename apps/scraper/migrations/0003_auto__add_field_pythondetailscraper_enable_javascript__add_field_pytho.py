...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PythonDetailScraper.enable_javascript'
        db.add_column('scraper_pythondetailscraper', 'enable_javascript',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PythonDetailScraper.enable_css'
        db.add_column('scraper_pythondetailscraper', 'enable_css',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PythonListScraper.enable_javascript'
        db.add_column('scraper_pythonlistscraper', 'enable_javascript',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PythonListScraper.enable_css'
        db.add_column('scraper_pythonlistscraper', 'enable_css',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PythonDetailScraper.enable_javascript'
        db.delete_column('scraper_pythondetailscraper', 'enable_javascript')

        # Deleting field 'PythonDetailScraper.enable_css'
        db.delete_column('scraper_pythondetailscraper', 'enable_css')

        # Deleting field 'PythonListScraper.enable_javascript'
        db.delete_column('scraper_pythonlistscraper', 'enable_javascript')

        # Deleting field 'PythonListScraper.enable_css'
        db.delete_column('scraper_pythonlistscraper', 'enable_css')
