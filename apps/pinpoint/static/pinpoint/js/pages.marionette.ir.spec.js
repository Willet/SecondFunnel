/*global SecondFunnel, describe, expect, it, sinon, waitsFor, runs*/
describe('intentRank', function () {
    ...
    var module = SecondFunnel.intentRank,
        ...
        mockAjaxError = function (parameters) {
            // make it asynchronous
            setTimeout(function () {
                parameters.error('jqXHR', 'textStatus', 'errorThrown');
            }, delay);
        };
    ...
    describe('changeCategory', function () {
        ...
        it('should not change the category if it\'s not a number',
            function () {
        ...
        it('should not change the category if it\'s legal but not valid (not meant for this campaign)',
            function () {
                var oldCategory = module.options.campaign;
        ...
        it('should change the category if it\'s a number and it\'s present',
            function () {
    ...
    describe('getResults', function () {
        it('should call getResultsOnline if options.page.offline is falsy',
            function () {
        ...
        it('should call getResultsOffline if options.page.offline is truthy',
            function () {
    ...
    describe('getResultsOnline', function () {
        ...
        it('should use its backup results if server returns nothing',
            function () {
                sinon.stub($, 'ajax', mockAjaxZeroResults);
                module.options.backupResults = [
                    {'backup': 'backup'}
                ];
                module.getResultsOnline(module.options, setResults);
        ...
        it('should use its backup results if we receive an Ajax error',
            function () {
