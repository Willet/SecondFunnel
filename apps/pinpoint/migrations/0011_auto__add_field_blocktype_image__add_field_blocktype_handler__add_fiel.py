...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlockType.image'
        db.add_column('pinpoint_blocktype', 'image',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlockType.handler'
        db.add_column('pinpoint_blocktype', 'handler',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlockType.enabled'
        db.add_column('pinpoint_blocktype', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlockType.image'
        db.delete_column('pinpoint_blocktype', 'image')

        # Deleting field 'BlockType.handler'
        db.delete_column('pinpoint_blocktype', 'handler')

        # Deleting field 'BlockType.enabled'
        db.delete_column('pinpoint_blocktype', 'enabled')
