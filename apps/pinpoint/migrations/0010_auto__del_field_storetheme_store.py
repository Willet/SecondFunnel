...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StoreTheme.store'
        db.delete_column('pinpoint_storetheme', 'store_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'StoreTheme.store'
        raise RuntimeError("Cannot reverse this migration. 'StoreTheme.store' and its values cannot be restored.")
