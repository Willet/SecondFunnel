...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StoreTheme.image_preview'
        db.delete_column('pinpoint_storetheme', 'image_preview')
    ...
    def backwards(self, orm):
        # Adding field 'StoreTheme.image_preview'
        db.add_column('pinpoint_storetheme', 'image_preview',
                      self.gf('django.db.models.fields.TextField')(default='\n<script type=\'text/template\' data-template-id=\'image-preview\'>\n    <img src=\'<%= data["image"] %>\'/>\n</script>\n    '),
                      keep_default=False)
