...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campaign.enabled'
        db.delete_column('pinpoint_campaign', 'enabled')

        # Adding field 'Campaign.live'
        db.add_column('pinpoint_campaign', 'live',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Campaign.enabled'
        db.add_column('pinpoint_campaign', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Campaign.live'
        db.delete_column('pinpoint_campaign', 'live')
