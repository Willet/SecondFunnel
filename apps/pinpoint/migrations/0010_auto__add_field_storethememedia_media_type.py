...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreThemeMedia.media_type'
        db.add_column('pinpoint_storethememedia', 'media_type',
                      self.gf('django.db.models.fields.CharField')(default='css', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreThemeMedia.media_type'
        db.delete_column('pinpoint_storethememedia', 'media_type')
    ...
    models = {
        ...
        'pinpoint.storethememedia': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'media_type': ('django.db.models.fields.CharField', [], {'default': "'css'", 'max_length': '3'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
