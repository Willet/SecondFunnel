...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MediaAsset'
        db.create_table('pinpoint_mediaasset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('pinpoint', ['MediaAsset'])

        # Adding model 'Product'
        db.create_table('pinpoint_product', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal('pinpoint', ['Product'])

        # Adding M2M table for field images on 'Product'
        db.create_table('pinpoint_product_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm['pinpoint.product'], null=False)),
            ('mediaasset', models.ForeignKey(orm['pinpoint.mediaasset'], null=False))
        ))
        db.create_unique('pinpoint_product_images', ['product_id', 'mediaasset_id'])
        ...
        db.create_table('pinpoint_storetheme', (
            ...
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinpoint.Store'])),
            ('css', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('pinpoint', ['StoreTheme'])

        # Adding M2M table for field assets on 'StoreTheme'
        db.create_table('pinpoint_storetheme_assets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('storetheme', models.ForeignKey(orm['pinpoint.storetheme'], null=False)),
            ('mediaasset', models.ForeignKey(orm['pinpoint.mediaasset'], null=False))
        ))
        db.create_unique('pinpoint_storetheme_assets', ['storetheme_id', 'mediaasset_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'MediaAsset'
        db.delete_table('pinpoint_mediaasset')

        # Deleting model 'Product'
        db.delete_table('pinpoint_product')

        # Removing M2M table for field images on 'Product'
        db.delete_table('pinpoint_product_images')
        ...
        # Removing M2M table for field assets on 'StoreTheme'
        db.delete_table('pinpoint_storetheme_assets')
