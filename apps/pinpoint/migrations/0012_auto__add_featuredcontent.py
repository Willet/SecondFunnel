...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pinpoint_featuredcontent', (
            ...
            ('image', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['assets.GenericMedia'], unique=True)),
    ...
    models = {
        ...
        'pinpoint.featuredcontent': {
            'Meta': {'object_name': 'FeaturedContent'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['assets.GenericMedia']", 'unique': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
