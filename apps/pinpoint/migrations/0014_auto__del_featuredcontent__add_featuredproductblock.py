...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('pinpoint_featuredcontent')
        ...
        db.create_table('pinpoint_featuredproductblock', (
            ...
            ('custom_image', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['assets.GenericMedia'], unique=True, null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.create_table('pinpoint_featuredcontent', (
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Product'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['assets.GenericMedia'], unique=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('pinpoint', ['FeaturedContent'])
