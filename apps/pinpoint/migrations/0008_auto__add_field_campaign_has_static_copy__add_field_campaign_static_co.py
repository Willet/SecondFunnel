...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.has_static_copy'
        db.add_column('pinpoint_campaign', 'has_static_copy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Campaign.static_copy_timestamp'
        db.add_column('pinpoint_campaign', 'static_copy_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 2, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.has_static_copy'
        db.delete_column('pinpoint_campaign', 'has_static_copy')

        # Deleting field 'Campaign.static_copy_timestamp'
        db.delete_column('pinpoint_campaign', 'static_copy_timestamp')
    ...
    models = {
        ...
        'pinpoint.campaign': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'static_copy_timestamp': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
