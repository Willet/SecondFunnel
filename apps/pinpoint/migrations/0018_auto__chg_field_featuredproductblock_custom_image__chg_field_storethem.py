...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeaturedProductBlock.custom_image'
        db.alter_column('pinpoint_featuredproductblock', 'custom_image_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['assets.GenericImage'], unique=True, null=True))

        # Changing field 'StoreTheme.page_template'
        db.alter_column('pinpoint_storetheme', 'page_template', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'FeaturedProductBlock.custom_image'
        db.alter_column('pinpoint_featuredproductblock', 'custom_image_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['assets.GenericMedia'], unique=True, null=True))

        # Changing field 'StoreTheme.page_template'
        db.alter_column('pinpoint_storetheme', 'page_template', self.gf('django.db.models.fields.TextField')(null=True))
