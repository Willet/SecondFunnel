...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IntentRankCampaign.id'
        db.alter_column('pinpoint_intentrankcampaign', 'id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True))

    def backwards(self, orm):

        # Changing field 'IntentRankCampaign.id'
        db.alter_column('pinpoint_intentrankcampaign', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
