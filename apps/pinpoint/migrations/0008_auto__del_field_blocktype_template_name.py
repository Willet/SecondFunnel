...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlockType.template_name'
        db.delete_column('pinpoint_blocktype', 'template_name')


    def backwards(self, orm):
        # Adding field 'BlockType.template_name'
        db.add_column('pinpoint_blocktype', 'template_name',
