...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.store'
        db.add_column('pinpoint_campaign', 'store',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pinpoint.Store']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.store'
        db.delete_column('pinpoint_campaign', 'store_id')
    ...
    models = {
        ...
        'pinpoint.campaign': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'store': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pinpoint.Store']"})
        },
        'pinpoint.mediaasset': {
            'Meta': {'object_name': 'MediaAsset'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'pinpoint.product': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'images': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['pinpoint.MediaAsset']", 'null': 'True', 'blank': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'pinpoint.storetheme': {
            ...
            'assets': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['pinpoint.MediaAsset']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
