...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.supports_categories'
        db.add_column('pinpoint_campaign', 'supports_categories',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.supports_categories'
        db.delete_column('pinpoint_campaign', 'supports_categories')
