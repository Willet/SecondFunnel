...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IntentRankCampaign.id'
        db.delete_column('pinpoint_intentrankcampaign', 'id')

        # Adding field 'IntentRankCampaign.uuid'
        db.add_column('pinpoint_intentrankcampaign', 'uuid',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'IntentRankCampaign.id'
        raise RuntimeError("Cannot reverse this migration. 'IntentRankCampaign.id' and its values cannot be restored.")
        # Deleting field 'IntentRankCampaign.uuid'
        db.delete_column('pinpoint_intentrankcampaign', 'uuid')
    ...
    models = {
        ...
        'pinpoint.campaign': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'default_intentrank': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'campaign'", 'unique': 'True', 'null': 'True', 'to': "orm['pinpoint.IntentRankCampaign']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
