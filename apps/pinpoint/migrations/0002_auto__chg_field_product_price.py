...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pinpoint_product', 'price', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Product.price'
        db.alter_column('pinpoint_product', 'price', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
