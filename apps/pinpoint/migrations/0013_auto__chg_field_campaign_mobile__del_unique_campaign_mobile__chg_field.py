...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Campaign', fields ['theme']
        db.delete_unique('pinpoint_campaign', ['theme_id'])

        # Removing unique constraint on 'Campaign', fields ['mobile']
        db.delete_unique('pinpoint_campaign', ['mobile_id'])
    ...
    models = {
        ...
        'pinpoint.campaign': {
            ...
            'mobile': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'mobile'", 'null': 'True', 'to': "orm['pinpoint.StoreTheme']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
