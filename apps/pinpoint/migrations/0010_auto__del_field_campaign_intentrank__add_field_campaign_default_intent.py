...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campaign.intentrank'
        db.delete_column('pinpoint_campaign', 'intentrank_id')

        # Adding field 'Campaign.default_intentrank'
        db.add_column('pinpoint_campaign', 'default_intentrank',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinpoint.IntentRankCampaign'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'Campaign.intentrank'
        db.add_column('pinpoint_campaign', 'intentrank',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinpoint.IntentRankCampaign'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'pinpoint.campaign': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'default_intentrank': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pinpoint.IntentRankCampaign']", 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intentrank': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pinpoint.IntentRankCampaign']", 'null': 'True', 'blank': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
