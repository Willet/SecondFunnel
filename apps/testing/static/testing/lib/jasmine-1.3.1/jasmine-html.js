...
jasmine.HtmlReporterHelpers.createDom = function (type, attrs,
                                                  childrenVarArgs) {
    ...
    this.createResultsMenu = function () {
        this.resultsMenu = this.createDom('span',
            ...
            this.summaryMenuItem = this.createDom('a',
                {className: 'summaryMenuItem', href: "#"}, '0 specs'),
            ' | ',
            this.detailsMenuItem = this.createDom('a',
                {className: 'detailsMenuItem', href: "#"}, '0 failing'));
    ...
    this.refresh = function () {
        ...
        if (isUndefined(this.failedAlert)) {
            this.failedAlert = this.createDom('span',
                {href: "?", className: "failingAlert bar"});
        }
...
jasmine.TrivialReporter.prototype.reportRunnerStarting = function (runner) {
    ...
    this.outerDiv = this.createDom('div',
        ...
        this.runnerDiv = this.createDom('div', { className: 'runner running' },
            this.createDom('a', { className: 'run_spec', href: '?' },
                "run all"),
...
jasmine.TrivialReporter.prototype.reportRunnerResults = function (runner) {
    ...
    var message = "" + specCount + " spec" + (specCount == 1 ? ""
        : "s" ) + ", " + results.failedCount + " failure" + ((results.failedCount == 1)
        ? "" : "s");
    message += " in " + ((new Date().getTime() - this.startedAt.getTime()) / 1000) + "s";
    this.runnerMessageSpan.replaceChild(this.createDom('a',
        { className: 'description', href: '?'}, message),
